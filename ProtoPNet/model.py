    ...
    def forward(self, x):
        ...
        min_distances = -F.max_pool2d(-distances,
                                      kernel_size=(distances.size()[2],
                                                   distances.size()[3]))
        min_distances2 = min_distances.view(-1, self.num_prototypes)
        prototype_activations = self.distance_2_similarity(min_distances2)
        logits = self.last_layer(prototype_activations)
        return logits, min_distances2, distances, conv_features
